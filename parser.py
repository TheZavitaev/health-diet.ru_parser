...
#  1. Копируем html с категориями себе на ПК
...
#  2. Создаем JSON со всеми категориями
...
# 3. Пробегаемся по всем категориям и собираем данные.
...
for category_name, category_href in all_categories.items():
    ...
    for item in products_data:
        ...
        with open(f'data/{count}_{category_name}.csv', 'a',
